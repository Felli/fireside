 ...
 * @param string $index The key of the second dimension to sort the array by.
 ...
 *
 * @param integer[] $rgb The RGB triplet.
 * @return integer[] The HSL triplet.
 *
 * @package esoTalk
 */
 ...
 * @return integer[] The RGB triplet.
 *
 * @package esoTalk
 */
 ...
 * @return string hex color, with a leading #.
 *
 * @package esoTalk
 */
 ...
 * @param string $add The element to add.
