 ...
 * @return false|string The new channel ID, or false if there are errors.
 */
 ...
 *
 * @param int $channelIds The ID of the channel to set the member's status for.
 * @param int $memberIds The ID of the member to set the status for.
